...
{rows}
  ...
  <div class="caveats">
    <ul>
      <li><b>Precision 0.937, recall 0.985</b> across the pages the golden set
        ...
        evaluation criteria was found to have been missed entirely, and is excluded
        from these figures: its ground truth and its extraction share one reading of
        the page, so it is covered now but cannot measure itself. Across the whole golden set
